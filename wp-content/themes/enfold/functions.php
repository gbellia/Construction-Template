...
if( ! function_exists( 'avia_register_frontend_scripts' ) )
{
	...
	function avia_register_frontend_scripts()
	{
		...
		wp_enqueue_script( 'avia-waypoints', "{$template_url}/js/waypoints/waypoints{$min_js}.js", array( 'jquery' ), $vn, true );
		wp_enqueue_script( 'avia-default', "{$template_url}/js/avia{$min_js}.js", array( 'jquery' ), $vn, true );
...
//		wp_enqueue_script( 'avia-parallax', $template_url . '/js/parallax.js', array( 'jquery', 'avia-default' ), $vn, true );
		...
		*************************************************************************/
		...
		avia_enqueue_style_conditionally( $condition, 'avia-popup-css', "{$template_url}/js/aviapopup/magnific-popup{$min_css}.css", array( 'avia-layout' ), $vn, 'screen' );
		...
		avia_enqueue_script_conditionally( $condition, 'avia-popup-js', "{$template_url}/js/aviapopup/jquery.magnific-popup{$min_js}.js", array( 'jquery' ), $vn, true );
