...
$desc  = __( 'In order to increase the speed of your website you can activate file merging and compression for your CSS and Javascript files. This will reduce and optimize the amount of code loaded.', 'avia_framework' ) . '<br><br>';
$desc .= '<strong>' . __( 'Please note:', 'avia_framework' ) . ' </strong>';
$desc .= __( 'By default compression is enabled. It is recommended to only disable the feature when you encounter errors (some server environments might cause trouble with active compression) or while you are actively developing your website and are adding new CSS rules or Javascript functions.', 'avia_framework' ) . '<br><br>';
...
$avia_elements[] = array(
			...
			'desc'		=> __( 'Select which level of file merging and compression you want to apply to your CSS files. Minified files are recommended for best performance.', 'avia_framework' ),
			'id'		=> 'merge_css',
			'type'		=> 'select',
			'std'		=> 'avia',
			'no_first'	=> true,
			...
			'subtype'	=> array(
								...
								__( 'Use minified theme CSS files without merging', 'avia_framework' )				=> 'minified_only',
							)
		);
...
$avia_elements[] = array(
			...
			'desc'		=> __( 'Select which level of file merging and compression you want to apply to your Javascript files. Minified files are recommended for best performance.', 'avia_framework' ),
			'id'		=> 'merge_js',
			'type'		=> 'select',
			'std'		=> 'avia',
			'no_first'	=> true,
			...
			'subtype'	=> array(
								...
								__( 'Use minified theme javascript files without merging', 'avia_framework' )		=> 'minified_only',
							)
		);
...
$avia_elements[] = array(
			...
			'desc'		=> __( 'Background image parallax and delayed CSS animations when an element comes in viewport had been restricted on mobile devices prior to Enfold 5.0 due to limited resources on these devices. This has changed with modern devices. Activate this option if you still want to disable background image parallax and start most animations immediately when page has finished loading.', 'avia_framework' ),
