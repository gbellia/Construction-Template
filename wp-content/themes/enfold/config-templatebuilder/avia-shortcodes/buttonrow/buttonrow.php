...
if ( ! class_exists( 'avia_sc_buttonrow' ) )
{
    class avia_sc_buttonrow extends aviaShortcodeTemplate
    {
        ...
        public function extra_assets()
        {
			...
			wp_enqueue_style( 'avia-module-buttonrow', AviaBuilder::$path['pluginUrlRoot'] . "avia-shortcodes/buttonrow/buttonrow{$min_css}.css", array( 'avia-layout' ), $ver );
        }
		...
		protected function register_dynamic_templates()
		{
			...
			$c = array(
						...
						array(
							...
							'desc'			=> __( 'Select a custom font size for the button text. Used for all buttons, can also be set for each button seperate.', 'avia_framework' ),
							'type'			=> 'template',
			...
			$c = array(
						array(
								...
								'toggle'		=> true,
								'name_toggle'	=> __( 'Padding', 'avia_framework' ),
								'name'			=> __( 'Button Text Padding', 'avia_framework' ),
								'desc'			=> __( 'Set a responsive padding to text for the buttons. Used for all buttons, can also be set for each button seperate.', 'avia_framework' ),
								'content'		=> array( 'padding' ),
								'id_padding'	=> 'text-padding'
							)
				);
				...
				array(
					...
					array(
							...
							'templates_include'	=> array(
													...
													$this->popup_key( 'modal_styling_margin_padding' ),
		...
		protected function register_modal_group_templates()
		{
			...
			$c = array(
						array(
								...
								'toggle'		=> true,
								'name_toggle'	=> __( 'Padding', 'avia_framework' ),
								'name'			=> __( 'Button Padding', 'avia_framework' ),
								'desc'			=> __( 'Set a responsive padding to text for the button.', 'avia_framework' ),
								'content'		=> array( 'padding' ),
								'id_padding'	=> 'btn-padding'
							)
				);

			AviaPopupTemplates()->register_dynamic_template( $this->popup_key( 'modal_styling_margin_padding' ), $c );
		...
		protected function get_element_styles( array $args )
		{
			...
			$element_styling->add_responsive_font_sizes( 'container-fonts', 'size-btn-text', $atts, $this );

			$element_styling->create_callback_styles( $atts );

			$element_styling->add_responsive_styles( 'container-fonts', 'text-padding', $atts, $this );

			$selectors = array(
						'container'			=> ".avia-buttonrow-wrap.{$element_id}",
						'container-fonts'	=> ".avia-buttonrow-wrap.{$element_id} .avia-button"
					);
		...
		protected function get_element_styles_item( array $args )
		{
			...
			$element_styling->add_responsive_styles( 'container', 'btn-padding', $atts, $this );
