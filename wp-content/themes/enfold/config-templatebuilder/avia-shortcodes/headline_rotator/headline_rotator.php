...
if( ! class_exists( 'avia_sc_headline_rotator' ) )
{
	class avia_sc_headline_rotator extends aviaShortcodeTemplate
	{
		...
		function extra_assets()
		{
			...
			//load css
			wp_enqueue_style( 'avia-module-rotator', AviaBuilder::$path['pluginUrlRoot'] . "avia-shortcodes/headline_rotator/headline_rotator{$min_css}.css", array( 'avia-layout' ), $ver );

				//load js
			wp_enqueue_script( 'avia-module-rotator', AviaBuilder::$path['pluginUrlRoot'] . "avia-shortcodes/headline_rotator/headline_rotator{$min_js}.js", array( 'avia-shortcodes' ), $ver, true );
		}
