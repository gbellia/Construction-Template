...
if ( ! class_exists( 'avia_sc_audio_player' ) )
{
	...
	class avia_sc_audio_player extends aviaShortcodeTemplate
	{
		...
		function extra_assets()
		{
			...
			//load css
			wp_enqueue_style( 'avia-module-audioplayer', AviaBuilder::$path['pluginUrlRoot'] . "avia-shortcodes/audio-player/audio-player{$min_css}.css", array( 'avia-layout' ), $ver );

				//load js
			wp_enqueue_script( 'avia-module-audioplayer', AviaBuilder::$path['pluginUrlRoot'] . "avia-shortcodes/audio-player/audio-player{$min_js}.js", array( 'avia-shortcodes' ), $ver, true );
		}
...
//			$main .= '</span>';
		...
		public function shortcode_handler( $atts, $content = '', $shortcodename = '', $meta = '' )
		{
			...
			$output  = '';
			$output .= $style_tag;
			$output .= '<div id="' . $id . '" class="' . $container_class . '">';
