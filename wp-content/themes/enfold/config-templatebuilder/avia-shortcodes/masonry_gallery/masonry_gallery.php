...
if( ! class_exists( 'avia_sc_masonry_gallery' ) )
{
	class avia_sc_masonry_gallery extends aviaShortcodeTemplate
	{
		...
		function extra_assets()
		{
			...
			wp_enqueue_style( 'avia-module-masonry', AviaBuilder::$path['pluginUrlRoot'] . "avia-shortcodes/masonry_entries/masonry_entries{$min_css}.css", array( 'avia-layout' ), $ver );

			//loading icon
			wp_enqueue_style( 'avia-siteloader', get_template_directory_uri() . "/css/avia-snippet-site-preloader{$min_css}.css", array( 'avia-layout' ), $ver );
			...
			wp_enqueue_script( 'avia-module-masonry', AviaBuilder::$path['pluginUrlRoot'] . "avia-shortcodes/masonry_entries/masonry_entries{$min_js}.js", array( 'avia-module-isotope' ), $ver, true );
		}
			...
			$c = array(
						array(
							...
							'subtype'	=> array(
												...
												__( 'Use custom link (fallback is image link)', 'avia_framework' )		=> 'custom_image',
						...
						array(
							...
							'std'		=> '',
							'lockable'	=> true,
							'required'	=> array( 'container_links', 'parent_in_array', ',custom_image' ),
							'subtype'	=> array(
